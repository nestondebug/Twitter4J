...
public interface TweetsResources {
    ...
    /**
     * Uploads media using lazy chunked approach to be attached via {@link #updateStatus(twitter4j.StatusUpdate)}.
     * This should be used for videos.
     * <br>This method calls https://api.twitter.com/1.1/media/upload.json
     *
     * @param fileName media file name
     ...
     * @since Twitter4J 4.0.7
     */
    UploadedMedia uploadMediaChunked(String fileName, InputStream media, int length) throws TwitterException;
